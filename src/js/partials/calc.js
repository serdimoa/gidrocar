    ...
    switch (this.param) {
        case 1:
            var category_1 = new Category_value(
                [150, 200, 350, 100], [80, 50, 100, 100, 100, 100, 50, 50], [1200, 1100, 500, 500, 1000, 1000], [100, 350], [100, 30], [80, 80, 80]);
            category_1.init();
            break;
        case 2:
            var category_2 = new Category_value(
                [170, 220, 400, 100], [100, 60, 100, 100, 110, 110, 50, 50], [1300, 1200, 600, 600, 1100, 1100], [100, 400], [100, 40], [100, 100, 90]);
            category_2.init();
            break;
        case 3:
            var category_3 = new Category_value(
                [190, 240, 450, 110], [110, 70, 110, 100, 120, 120, 50, 50], [1500, 1500, 700, 700, 1500, 1400], [100, 450], [120, 40], [120, 120, 120]);
            category_3.init();
            break;
        case 4:
            var category_4 = new Category_value(
                [210, 260, 500, 120], [120, 70, 110, 100, 130, 130, 50, 50], [1700, 1600, 800, 800, 1800, 1800], [100, 500], [130, 50], [30, 40, 40]);
            category_4.init();
            break;
        case 5:
            var category_5 = new Category_value(
                [230, 280, 550, 130], [130, 70, 110, 100, 140, 140, 50, 50], [1800, 1700, 900, 900, 1900, 1900], [100, 500], [140, 60], [10, 10, 20]);
            category_5.init();
            break;
    }
};
